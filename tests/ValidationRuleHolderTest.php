...
class ValidationRuleHolderTest extends TestCase
{
    ...
    {
        $className = (new ValidationRepo)->for(Model::class)->getClassPath();
    ...
    function an_array_of_rules_can_be_set()
    {
        ...
        $returnedRules = (new ValidationRepo)->for(Model::class)->setRules($rules)->get();
    ...
    function rules_can_be_overridden_by_a_new_rule_array()
    {
        ...
        $returnedRules = (new ValidationRepo)->for(Model::class)
